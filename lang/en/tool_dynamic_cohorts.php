...
$string['settings:crononly'] = 'Cron only';
$string['settings:crononly_desc'] = 'If enabled, event processing will be turned off, and cohort rules, conditions, and matching will be updated through the use of the cron task only. <b>This setting is recommended for systems that require high performance processing of events</b>.';

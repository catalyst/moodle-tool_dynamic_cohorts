...
$string['condition:user_profile_interests_description'] = 'Users interested in any of the following tags {$a}';
$string['condition:user_profile_interests_description_not'] = 'Users not interested in any of the following tags {$a}';

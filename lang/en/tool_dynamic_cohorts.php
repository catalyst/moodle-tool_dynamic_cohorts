...
$string['condition:course_completion:completionisdisabled'] = 'Completion tracking is disabled (course id {$a->courseid}).';
$string['condition:course_completion:config_description'] = 'Users who {$a->completionoperator} {$a->selectionoperator} of the following courses{$a->periodclause}: {$a->coursebadges}';
...
$string['condition:course_completion:missingcourse'] = 'Course doesn\'t exist (course id {$a->courseid}).';
$string['condition:course_completion:name'] = 'Course completion';
